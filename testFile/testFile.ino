...
#define lidar1_pin A0
#define lidar2_pin A1
#define lidar3_pin A2
...
void loop() {
    ...
    //if (lidar1.readRangeSingleMillimeters() || lidar2.readRangeSingleMillimeters() || lidar3.readRangeSingleMillimeters() < WALL_DETECTION) {
        //stopMotors();
        //return;
    //}
